...
- [ ] Missing-010: Upgrade `taxonomy.json` beyond a scaffold, and enforce tags belong to taxonomy
...
- [ ] Missing-011: Build `formula_graph` from arXiv sources + maintain `manual_formula_queue`
...
- [ ] Missing-012: Add field-level provenance (at least source type + snapshot references)
  - Location: `provetok/src/provetok/dataset/pipeline.py`, `provetok/src/provetok/dataset/record_builder.py`
...
- [ ] Missing-013: Expand v2 attack suite with a time-index/canonical-order test (script + docs)
...
- [ ] Missing-014: Implement additional selection signals (burst/community/bridge) *or* downgrade plan claims
...
- [ ] Missing-016: Integrate Papers-with-Code dump as an auxiliary QA cross-check *or* downgrade plan claims
...
- [ ] Missing-017: Support private (hidden) SDG seeds for leaderboard use
...
- [ ] Amb-002: Name/identity fingerprint policy in public text
