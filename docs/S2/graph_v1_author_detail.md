...
**接口路径：** `GET https://ai4scholar.net/graph/v1/author/{author_id}`
...
• `https://ai4scholar.net/graph/v1/author/1741101`

• 返回作者的 authorId 和 name。

• `https://ai4scholar.net/graph/v1/author/1741101?fields=url,papers`

• 返回作者的 authorId、url 和论文列表。
• 每篇论文包含 paperId 和 title。

• `https://ai4scholar.net/graph/v1/author/1741101?fields=url,papers.abstract,papers.authors`

• 返回作者的 authorId、url 和论文列表。
• 每篇论文包含 paperId、abstract 和作者列表。
...
url = "https://ai4scholar.net/graph/v1/author/{author_id}"
headers = {
    "x-api-key": API_KEY,
}
...
```bash
curl -X GET "https://ai4scholar.net/graph/v1/author/{author_id}" \
