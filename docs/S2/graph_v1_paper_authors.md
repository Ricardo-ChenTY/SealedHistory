...
**接口路径：** `GET https://ai4scholar.net/graph/v1/paper/{paper_id}/authors`
...
• `https://ai4scholar.net/graph/v1/paper/649def34f8be52c8b66281af98ae884c09aef38b/authors`

• 返回 offset=0，data 是包含全部 3 位作者的列表。
• 每个作者包含 authorId 和 name。

• `https://ai4scholar.net/graph/v1/paper/649def34f8be52c8b66281af98ae884c09aef38b/authors?fields=affiliations,papers&limit=2`

• 返回 offset=0, next=2，data 是包含 2 位作者的列表。
• 每个作者包含 authorId、affiliations 和论文列表。
• 每篇论文包含 paperId 和 title。

• `https://ai4scholar.net/graph/v1/paper/649def34f8be52c8b66281af98ae884c09aef38b/authors?fields=url,papers.year,papers.authors&offset=2`

• 返回 offset=2，data 是包含最后一位作者的列表。
• 该作者包含 authorId、url 和论文列表。
• 每篇论文包含 paperId、year 和作者列表。
• 作者列表中每个作者包含 authorId 和 name。
...
url = "https://ai4scholar.net/graph/v1/paper/{paper_id}/authors"
headers = {
    "x-api-key": API_KEY,
}
...
```bash
curl -X GET "https://ai4scholar.net/graph/v1/paper/{paper_id}/authors" \
