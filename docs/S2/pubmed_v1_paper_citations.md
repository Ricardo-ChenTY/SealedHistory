...
**接口路径：** `GET https://ai4scholar.net/pubmed/v1/paper/{pmid}/citations`
...
url = "https://ai4scholar.net/pubmed/v1/paper/{pmid}/citations"
headers = {
    "x-api-key": API_KEY,
}
...
```bash
curl -X GET "https://ai4scholar.net/pubmed/v1/paper/{pmid}/citations" \
